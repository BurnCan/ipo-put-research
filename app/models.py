...
class LockupSignalSnapshot(Base):
    ...
    expected_history_start_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    expected_history_end_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    expected_history_sessions: Mapped[int | None] = mapped_column(Integer, nullable=True)
    missing_history_sessions: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    trading_sessions_since_first_trade: Mapped[int | None] = mapped_column(Integer, nullable=True)
    available_history_sessions: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    post_ipo_high_to_date: Mapped[float | None] = mapped_column(Numeric(20, 8), nullable=True)
    drawdown_from_post_ipo_high: Mapped[float | None] = mapped_column(Numeric(20, 10), nullable=True)
    post_ipo_low_to_date: Mapped[float | None] = mapped_column(Numeric(20, 8), nullable=True)
